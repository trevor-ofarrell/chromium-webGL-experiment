...
Generated: 2026-05-28T23:47:48.674Z

Input results: 28
Input file digest: `0e658d0f70429d062e6340a930a7efc3ba30d65b793fbda01dc031db830755ab`
Accepted results: 28
Filtered results: 0
...
| official | webgpu | baseline-content-shell-webgpu-paired-colorconv | fork-viewer-exp-webgpu-colorspace-paired | fresh-profile-evidence | fresh-temp/fresh-temp | 7 | blocked-tail | 1.81 | -0.06 | -0.41 | -5.55 | -2.41 | -2.36 | 0.57 | -0.31 | 0.00 | 0.00 | -0.30 | -0.28 | -158.5 | -5.8 |
...
| --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | fork-viewer-exp-webgpu-colorspace-paired | blocked-tail | gltf-loader-stress | 0.1% low -27.44 FPS | -0.06 | -3.21 | -27.44 | 0.00 | 0.00 | 1.00 | -0.31 | 0.00 | 0.00 | 0.11 | 0.12 |
...
| webgpu | 0 | blocked-tail | fork-viewer-exp-webgpu-colorspace-paired | 7 | 1.81 | -0.06 | -2.36 | 0.57 | -0.31 | 0.00 | 0.00 |

Failures:
- webgpu: fork-viewer-exp-webgpu-colorspace-paired vs baseline-content-shell-webgpu-paired-colorconv: status=blocked-tail, scenes=7, avg_fps_delta_pct=1.81, p99_delta_ms=-2.36
