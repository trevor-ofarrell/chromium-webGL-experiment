...
Generated: 2026-05-29T00:56:24.623Z

Input results: 14
Input file digest: `10e6ea513acf0f2135f8982f5ee6b3bf8364ec6ddf2d259aae12d1f9c9407253`
Accepted results: 14
Filtered results: 0
...
| --- | --- | --- | --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | baseline-content-shell-webgpu-alt-warmup | fork-viewer-default-webgpu-alt-warmup | fresh-profile-evidence | fresh-temp/fresh-temp | 7 | blocked-dropped-frames | 1.45 | -0.85 | -0.36 | -0.15 | -0.01 | 0.06 | -1.29 | -0.44 | 0.00 | 0.00 | -0.21 | -0.18 | -110.2 | -4.6 |
...
| --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | fork-viewer-default-webgpu-alt-warmup | blocked-dropped-frames | gltf-loader-stress | dropped frame rate +0.87 pp | -0.85 | -0.05 | 0.00 | 0.00 | 0.20 | 15.00 | 0.87 | 0.00 | 0.00 | 0.59 | 0.60 |
...
| --- | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| webgpu | 0 | blocked-dropped-frames | fork-viewer-default-webgpu-alt-warmup | 7 | 1.45 | -0.85 | 0.06 | -1.29 | -0.44 | 0.00 | 0.00 |

Failures:
- webgpu: fork-viewer-default-webgpu-alt-warmup vs baseline-content-shell-webgpu-alt-warmup: status=blocked-dropped-frames, scenes=7, avg_fps_delta_pct=1.45, p99_delta_ms=0.06
