...
Generated: 2026-05-29T04:17:43.008Z

Input results: 4
Input file digest: `41e731ee8894f5ab38750ca4c7b6343ff8f1fb5ab7cb80e0dffee63279b3ef06`
Accepted results: 4
Filtered results: 0
...
| --- | --- | --- | --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | baseline-content-shell-webgpu-canvasmem-probe | fork-viewer-exp-webgpu-canvasmem-probe | fresh-profile-evidence | fresh-temp/fresh-temp | 2 | not useful | -0.29 | -2.75 | -10.95 | 0.42 | -8.30 | -25.20 | 54.00 | 1.42 | 0.00 | 0.00 | -0.46 | -0.44 | -171.8 | -2.8 |
...
| --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | fork-viewer-exp-webgpu-canvasmem-probe | not useful | gltf-loader-stress | avg FPS -2.75% | -2.75 | -23.03 | -0.30 | 0.00 | 16.50 | 99.00 | 1.42 | 0.00 | 0.00 | -0.40 | -0.39 |
...
| --- | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| webgpu | 0 | not useful | fork-viewer-exp-webgpu-canvasmem-probe | 2 | -0.29 | -2.75 | -25.20 | 54.00 | 1.42 | 0.00 | 0.00 |

Failures:
- webgpu: fork-viewer-exp-webgpu-canvasmem-probe vs baseline-content-shell-webgpu-canvasmem-probe: status=not useful, scenes=2, avg_fps_delta_pct=-0.29, p99_delta_ms=-25.20
