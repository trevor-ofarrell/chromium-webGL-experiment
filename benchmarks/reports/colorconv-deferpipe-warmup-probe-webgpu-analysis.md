...
| --- | --- | --- | --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | baseline-content-shell-webgpu-colorconv-deferpipe-warmup-probe | fork-viewer-exp-webgpu-colorconv-deferpipe-warmup-probe | fresh-profile-evidence | fresh-temp/fresh-temp | 2 | not useful | -4.30 | -8.43 | -0.58 | -0.57 | 57.50 | 50.05 | -5.50 | 0.09 | 0.00 | 0.00 | 0.50 | 0.49 | -810.0 | -1.4 |
...
| --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | fork-viewer-exp-webgpu-colorconv-deferpipe-warmup-probe | not useful | texture-streaming | avg FPS -8.43% | -8.43 | -1.06 | -1.06 | 114.90 | 100.00 | -14.00 | 0.09 | 0.00 | 0.00 | 0.83 | 0.81 |
