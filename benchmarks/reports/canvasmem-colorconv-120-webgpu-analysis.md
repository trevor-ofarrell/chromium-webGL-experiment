...
Generated: 2026-05-29T04:10:02.932Z

Input results: 14
Input file digest: `538896b1ab82882e8d54eb40f355195f18b6637b91775127b5e5cd431073837d`
Accepted results: 14
Filtered results: 0
...
| --- | --- | --- | --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | baseline-content-shell-webgpu-canvasmem-colorconv-120 | fork-viewer-exp-webgpu-canvasmem-colorconv-120 | fresh-profile-evidence | fresh-temp/fresh-temp | 7 | not useful | -0.27 | -3.72 | -1.99 | -0.88 | -2.36 | -9.69 | 4.29 | -0.29 | 0.00 | 0.00 | 0.05 | 0.05 | 832.4 | -13.0 |
...
| --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | fork-viewer-exp-webgpu-canvasmem-colorconv-120 | not useful | gltf-loader-stress | avg FPS -3.72% | -3.72 | -15.95 | -4.47 | 0.10 | 16.50 | 265.00 | -0.29 | 0.00 | 0.00 | 1.47 | 1.46 |
...
| --- | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| webgpu | 0 | not useful | fork-viewer-exp-webgpu-canvasmem-colorconv-120 | 7 | -0.27 | -3.72 | -9.69 | 4.29 | -0.29 | 0.00 | 0.00 |

Failures:
- webgpu: fork-viewer-exp-webgpu-canvasmem-colorconv-120 vs baseline-content-shell-webgpu-canvasmem-colorconv-120: status=not useful, scenes=7, avg_fps_delta_pct=-0.27, p99_delta_ms=-9.69
