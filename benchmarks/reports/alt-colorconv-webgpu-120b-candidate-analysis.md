...
Generated: 2026-05-29T03:10:58.536Z

Input results: 14
Input file digest: `5d8aabe89edfcb8a02f459b823785647d464e2439bc3c69dfc645e5f9a00f859`
Accepted results: 14
Filtered results: 0
...
| --- | --- | --- | --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | baseline-content-shell-webgpu-alt-colorconv-120b | fork-viewer-exp-webgpu-colorconv-alt-120b | fresh-profile-evidence | fresh-temp/fresh-temp | 7 | blocked-cpu-overhead | 4.03 | -0.35 | 0.83 | -1.31 | -7.16 | -21.49 | -95.29 | -2.89 | 0.00 | 0.00 | -0.50 | -0.48 | -297.4 | -11.2 |
...
| --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | fork-viewer-exp-webgpu-colorconv-alt-120b | blocked-cpu-overhead | gltf-loader-stress | CPU frame +1.21 ms | -0.35 | -0.25 | -1.70 | 0.00 | 15.60 | 24.00 | -2.89 | 0.00 | 0.00 | 1.21 | 1.20 |
...
| --- | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| webgpu | 0 | blocked-cpu-overhead | fork-viewer-exp-webgpu-colorconv-alt-120b | 7 | 4.03 | -0.35 | -21.49 | -95.29 | -2.89 | 0.00 | 0.00 |

Failures:
- webgpu: fork-viewer-exp-webgpu-colorconv-alt-120b vs baseline-content-shell-webgpu-alt-colorconv-120b: status=blocked-cpu-overhead, scenes=7, avg_fps_delta_pct=4.03, p99_delta_ms=-21.49
