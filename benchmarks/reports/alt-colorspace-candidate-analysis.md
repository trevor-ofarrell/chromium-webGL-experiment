...
Generated: 2026-05-29T00:20:36.422Z

Input results: 28
Input file digest: `39fbbd31b02eaa0e818c4b5d7147bb6bcc102b2b34c742aed1351891293f0c51`
Accepted results: 28
Filtered results: 0
...
| official | webgpu | baseline-content-shell-webgpu-alt-colorspace | fork-viewer-exp-webgpu-colorspace-alt | fresh-profile-evidence | fresh-temp/fresh-temp | 7 | blocked-throughput | 0.07 | -1.96 | -1.31 | -1.63 | -0.01 | -0.01 | -3.00 | -0.52 | 0.00 | 0.00 | -0.08 | -0.08 | -217.6 | -6.9 |
...
| --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | fork-viewer-exp-webgpu-colorspace-alt | blocked-throughput | gltf-loader-stress | avg FPS -1.96% | -1.96 | -5.07 | 0.00 | 0.00 | 16.30 | 35.00 | -0.52 | 0.00 | 0.00 | 0.46 | 0.46 |
...
| webgpu | 0 | blocked-throughput | fork-viewer-exp-webgpu-colorspace-alt | 7 | 0.07 | -1.96 | -0.01 | -3.00 | -0.52 | 0.00 | 0.00 |

Failures:
- webgpu: fork-viewer-exp-webgpu-colorspace-alt vs baseline-content-shell-webgpu-alt-colorspace: status=blocked-throughput, scenes=7, avg_fps_delta_pct=0.07, p99_delta_ms=-0.01
