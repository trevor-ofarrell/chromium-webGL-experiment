...
Generated: 2026-05-28T23:37:57.582Z

Input results: 28
Input file digest: `ca9db304ae1c513f848029a1f53a81f175f8c73b743ec24697a032571ae3d194`
Accepted results: 28
Filtered results: 0
...
| official | webgpu | baseline-content-shell-webgpu-paired-colorconv | fork-viewer-exp-webgpu-colorconv-defer-pipeline-paired | fresh-profile-evidence | fresh-temp/fresh-temp | 7 | not useful | -0.63 | -17.26 | -3.39 | -2.97 | 21.46 | 23.81 | -24.14 | -2.40 | 0.00 | 0.00 | 0.28 | 0.27 | -94.2 | -4.9 |
...
| --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| official | webgpu | fork-viewer-exp-webgpu-colorconv-defer-pipeline-paired | not useful | texture-streaming | avg FPS -17.26% | -17.26 | -1.78 | -1.78 | 150.20 | 150.20 | -31.00 | -2.40 | 0.00 | 0.00 | 2.27 | 2.14 |
...
| webgpu | 0 | not useful | fork-viewer-exp-webgpu-colorconv-defer-pipeline-paired | 7 | -0.63 | -17.26 | 23.81 | -24.14 | -2.40 | 0.00 | 0.00 |

Failures:
- webgpu: fork-viewer-exp-webgpu-colorconv-defer-pipeline-paired vs baseline-content-shell-webgpu-paired-colorconv: status=not useful, scenes=7, avg_fps_delta_pct=-0.63, p99_delta_ms=23.81
