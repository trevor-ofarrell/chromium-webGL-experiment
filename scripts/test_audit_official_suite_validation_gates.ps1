...
Assert-Matches "Official performance.*Stock WebGL2 scene suite results[\s\S]*-RejectSoftwareRendering[\s\S]*-RequireGpuMetadata[\s\S]*-RequireFrameTimes" "stock WebGL2 audit row strict GPU and frame-time validation"
...
Assert-Matches "Official performance.*Fork default WebGL2 scene suite results[\s\S]*-RejectSoftwareRendering[\s\S]*-RequireGpuMetadata[\s\S]*-RequireFrameTimes" "fork WebGL2 audit row strict GPU and frame-time validation"
...
Assert-Matches "Official performance.*Stock WebGPU scene suite results[\s\S]*-RejectSoftwareRendering[\s\S]*-RequireGpuMetadata[\s\S]*-RequireFrameTimes" "stock WebGPU audit row strict GPU and frame-time validation"
...
Assert-Matches "Official performance.*Fork WebGPU scene suite results[\s\S]*-RejectSoftwareRendering[\s\S]*-RequireGpuMetadata[\s\S]*-RequireFrameTimes" "fork WebGPU audit row strict GPU and frame-time validation"
...
Write-Host "Artifact audit official suite rows enforce GPU/software, frame-time samples, Chromium revision, browser executable, build-args hash, duration/warmup, and viewer flag metadata validation gates."
