...
Assert-Matches 'allow_viewer_patch_applied' "explicit patched-source opt-in validation for build provenance"
Assert-Matches 'baseline_source_guard_enabled' "stock baseline source-guard provenance validation"
Assert-Matches 'stock baseline evidence must not allow patched source' "stock baseline rejection for -AllowViewerPatchApplied provenance"
